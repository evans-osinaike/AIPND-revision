...
def calculates_results_stats(results_dic):
    ...
    for image in results_dic:
        ...
        if results_dic[image][3] == 1 and results_dic[image][4] == 1:
            n_correct_dogs += 1
        if results_dic[image][3] == 0 and results_dic[image][3] == 0:
            n_correct_notdogs += 1
        if results_dic[image][3] == 1 and results_dic[image][2] == 1:
            n_correct_breed += 1

    # Objective 1a: Percentage of Correctly Classified Dog Images
    results_stats_dic['pct_correct_dogs'] = (n_correct_dogs/n_dogs_img) * 100 # percentage of correctly classified dogs

    # Objective 1b: Percentage of Correctly Classified Non-Dog Images
    if n_notdogs_img != 0:      # percentage of correctly classified NON-dogs
    ...
    results_stats_dic['pct_correct_breed'] = (n_correct_breed/n_dogs_img) * 100 # percentage of correctly classified dog breeds

    # (Optional): Percentage Label Matches ( regardless if they're a dog)
    results_stats_dic['pct_match'] = (n_match/n_images) * 100 # percentage of correct matches
